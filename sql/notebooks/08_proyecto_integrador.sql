...
-- MAGIC 
-- MAGIC Bienvenida y bienvenido al **capstone** del curso **SQL para Ciencia de Datos usando Databricks**.
-- MAGIC 
...
-- MAGIC 
-- MAGIC Has completado el **Proyecto Integrador** del curso **SQL para Ciencia de Datos usando Databricks**.
-- MAGIC 
