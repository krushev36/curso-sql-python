...
-- MAGIC ## 1. Bienvenida
-- MAGIC
-- MAGIC Bienvenidos al séptimo notebook del curso **Fundamentos de Programación** de la **Maestría en Ciencia de Datos e Inteligencia de Negocios** de la **Universidad de Antioquia**.
-- MAGIC
